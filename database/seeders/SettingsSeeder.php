...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            // Global
            ['site_title', 'Destination Marker'],
            ['site_title_full', 'Destination Marker Educare'],
            ...
            ['site_information', 'Destination Marker Educare'],

            ['site_phone', '01-5907931'],
            ['site_email', 'destinationmarker@gmail.com'],
            ['site_location', 'Kathmandu, Nepal'],
            ['site_location_url', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d440.57915189381816!2d85.32309917747837!3d27.668628534399804!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb193be21aea5b%3A0xaa83ef792abf1f63!2sDestinationmarker%20Educare%20Consultancy!5e1!3m2!1sen!2snp!4v1744195769373!5m2!1sen!2snp'],
            ['site_mail', 'mail.destinationmarker.com.np'],
            ['site_url', '/'],

            ['site_copyright', 'Destination Marker'],
            ...
            ['contact_description', 'Destination Marker'],

            ['contact_location', 'Chitwan, Kathmandu'],
            ['contact_email', 'info@destinationmarker.com'],
            ...
            ['contact_seo_title', 'Destination Marker'],
            ['contact_seo_description', 'Destination Marker'],
            ['contact_seo_keywords', 'Destination Marker'],
            ['contact_seo_schema', 'Destination Marker'],
            ...
            ['homepage_seo_title', 'Destination Marker'],
            ['homepage_seo_keywords', 'Destination Marker'],
            ['homepage_meta_description', 'Destination Marker'],
            ['homepage_seo_schema', 'Destination Marker'],
